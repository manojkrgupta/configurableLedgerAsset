...
@InitiatingFlow(protocol = "final-commit")
class FinalCommit(private val signedTransaction: UtxoSignedTransaction, private val otherMember: List<MemberX500Name>): SubFlow<String> {
    ...
    override fun call(): String {
        ...
        log.info("Final Commit call() called")
...
@InitiatedBy(protocol = "final-commit")
class FinalCommitResponder: ResponderFlow {
    ...
    override fun call(session: FlowSession) {
        ...
        log.info("Final commit responderFlow.call() called")
        ...
        try {
            ...
            val finalizedSignedTransaction = ledgerService.receiveFinality(session) { ledgerTransaction ->
                ...
                val state = ledgerTransaction.getOutputStates(Instrument::class.java).singleOrNull() ?:
